...
def get_sect_df(gridname):
    ...
    if gridname == 'cas6':
        ...
        sect_df.loc['basin1',:] = [1.7815475813532617, 1.7815475813532617,   44.75,   45.25]
        sect_df.loc['sill1L',:] = [1.5524914637506995, 1.5524914637506995,   44.75,   45.25]
        sect_df.loc['sill1M',:] = [1.5270407840170814, 1.5270407840170814,   44.75,   45.25]
        sect_df.loc['sill1S',:] = [1.5015901042834634, 1.5015901042834634,   44.75,   45.25]
        sect_df.loc['basin2',:] = [1.2725339866809011, 1.2725339866809011,   44.75,   45.25]
        sect_df.loc['sill2L',:] = [1.043477869078339, 1.043477869078339,   44.75,   45.25]
        sect_df.loc['sill2M',:] = [1.018027189344721, 1.018027189344721,   44.75,   45.25]
        sect_df.loc['sill2S',:] = [0.9925765096111029, 0.9925765096111029,   44.75,   45.25]
        sect_df.loc['basin3',:] = [0.7635203920085407, 0.7635203920085407,   44.75,   45.25]
        sect_df.loc['sill3L',:] = [0.5344642744059785, 0.5344642744059785,   44.75,   45.25]
        sect_df.loc['sill3M',:] = [0.5090135946723605, 0.5090135946723605,   44.75,   45.25]
        sect_df.loc['sill3S',:] = [0.4835629149387424, 0.4835629149387424,   44.75,   45.25]
        sect_df.loc['basin4',:] = [0.25450679733618026, 0.25450679733618026,   44.75,   45.25]
