# THIS IS A VERSION OF create_sections_user WITH ONLY ONE SECTION (same as b5) AT THE LANDWARD END OF THE SILL
# This will allow us to use the segment tools to get the mean salinity of the inner basin
...
parser.add_argument('-ctag','--collection_tag', default='cinner', type=str)
