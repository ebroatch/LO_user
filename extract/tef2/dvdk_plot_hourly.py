...
in_dir = out_dir0 / ('dvdk_' + Ldir['ds0'] + '_' + Ldir['ds1'])
in_dir2 = out_dir0 / ('processed_' + Ldir['ds0'] + '_' + Ldir['ds1'])
out_dir = out_dir0 / ('dvdk_plots_hourly_' + Ldir['ds0'] + '_' + Ldir['ds1'])
...
for i in range(len(sect_list)):
    ...
    axs[3].plot(ot, F0, color=plot_color[i], linewidth=lw, label=sect_label[i])
    axs[1].plot(ot, F1, color=plot_color[i], linewidth=lw, label=sect_label[i])
    axs[2].plot(ot, F2, color=plot_color[i], linewidth=lw, label=sect_label[i])
