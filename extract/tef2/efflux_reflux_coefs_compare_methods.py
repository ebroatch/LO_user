...
ax.plot(silllens_plot,alpha_34_adj,marker='o',c='tab:pink',ls='-',label='TEF box model')
ax.plot(silllens_plot,alpha_21_adj,marker='o',c='tab:cyan',ls='-',label='TEF box model')
ax.plot(silllens_plot,alpha_24_adj,marker='o',c=plt.cm.tab20(13),ls='-',label='TEF box model')
ax.plot(silllens_plot,alpha_31_adj,marker='o',c=plt.cm.tab20(19),ls='-',label='TEF box model')
ax.plot(silllens_plot,alpha_34_par_ta,marker='o',c='tab:pink',ls='--',label='tidally averaged particles')
