...
UT_neap_5=0.69228
Frf_5=Frf
M_spring_5=np.sqrt((Cd*UT_spring_5*UT_spring_5)/(omega*N0*H_sill*H_sill))
M_neap_5=np.sqrt((Cd*UT_neap_5*UT_neap_5)/(omega*N0*H_sill*H_sill))
# M_spring_5=0.454
# M_neap_5=0.217
# Frf_5=0.00189
...
ax.set_xticks([2e-1,3e-1,4e-1,5e-1,6e-1,7e-1, 8e-1])
ax.set_xlim(right=8e-1)
