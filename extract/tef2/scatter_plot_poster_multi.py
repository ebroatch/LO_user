...
ax2.set_xlim(left=4e3,right=5e4)
ax2.set_ylim(bottom=4e3, top=5e4)
ax2.set_xlim(left=2e3,right=3e4)
ax2.set_ylim(bottom=2e3, top=3e4)
ax3.set_xlim(left=8e2,right=3e4)
ax3.set_ylim(bottom=8e2, top=3e4)
