...
for i in range(len(sect_list)):
    axs[i].errorbar(LsLtratio,pg_mean[i,:],yerr=pg_std[i,:],color='tab:red', label='Pressure gradient',marker='o',markersize=5,lw=1,capsize=6,ls='None')
...
axs[0].text(0.02,0.9,'A',ha='left',va='top',fontweight='bold',fontsize=18,transform=axs[0].transAxes)
axs[1].text(0.02,0.9,'B',ha='left',va='top',fontweight='bold',fontsize=18,transform=axs[1].transAxes)
axs[2].text(0.02,0.9,'C',ha='left',va='top',fontweight='bold',fontsize=18,transform=axs[2].transAxes)
