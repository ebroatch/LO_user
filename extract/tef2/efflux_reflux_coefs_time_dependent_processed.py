...
ax3.plot(plot_time,S1-S4,ls='-',label=r'S1-S4')
ax3.plot(plot_time,1/(S1-S4),ls='-',label=r'1/(S1-S4)')
ax4.plot(plot_time,storage_21_top,ls='-',label=r'storage_21_top')
ax1.set_title('Components of top layer alpha_21 storage term')
