...
in_dir = out_dir0 / ('bulk_mombal_area_' + Ldir['ds0'] + '_' + Ldir['ds1'])
out_dir = out_dir0 / ('bulk_mombal_area_plots_' + Ldir['ds0'] + '_' + Ldir['ds1'])
...
for i in range(len(sect_list)):
    ...
    tef_df, vn_list, vec_list = tfm.get_two_layer_area(in_dir, sect_name)
    ...
    # axs[i,0].set_ylim(-0.0005,0.0005) #PUT THESE BACK AFTER FIRST TEST PLOT
