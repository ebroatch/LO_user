# THIS IS A VERSION OF create_sections_user WITH TWO SECTIONS (same as a1 and b5) AT THE MOUTH OF THE ESTUARY AND LANDWARD END OF THE SILL
# This will allow us to use the segment tools to get the mean salinity of the whole estuary and inner basin
...
parser.add_argument('-ctag','--collection_tag', default='cei', type=str)
