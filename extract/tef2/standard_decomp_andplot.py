...
for ext_fn in sect_list:
    ...
    axs[0].pcolormesh(ds['vel'].sel(time=t_spring))
    axs[1].pcolormesh(ds['salt'].sel(time=t_spring))
    axs[2].pcolormesh(ds['vel'].sel(time=t_neap))
    axs[3].pcolormesh(ds['salt'].sel(time=t_neap))
