...
axs[2,0].text(.04, .5, 'E', horizontalalignment='left', verticalalignment='center', transform=axs[2,0].transAxes, fontsize=14, fontweight='bold')
axs[2,1].text(.04, .5, 'F', horizontalalignment='left', verticalalignment='center', transform=axs[2,1].transAxes, fontsize=14, fontweight='bold')
