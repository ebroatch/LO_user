...
ax1.plot(silllens_plot,exposure_est_days,c='tab:brown',marker='o',label='Exposure time')
ax1.plot(silllens_plot,residence_est_days,c=plt.cm.tab20b(14),marker='o',label='Strict residence time')
...
ax2.plot(silllens_plot,exposure_inner_days,c='tab:brown',marker='o',label='Exposure time')
ax2.plot(silllens_plot,residence_inner_days,c=plt.cm.tab20b(14),marker='o',label='Strict residence time')
...
ax1.set_xlim(0,85)
ax2.set_xlim(0,85)
# ax1.set_ylim(30,75) #set these once we see the results
# ax2.set_ylim(30,75)
