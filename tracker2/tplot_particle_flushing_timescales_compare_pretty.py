...
handles_reorder = handles[::-1]
labels_reorder = labels[::-1]
ax1.legend(handles_reorder,labels_reorder,loc='lower right')
...
fn_fig = Ldir['LOo'] / 'plots' / 'particle_flushing_timescales_compare_pretty.png'
plt.savefig(fn_fig)
plt.close()
