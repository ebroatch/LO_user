...
for i in range(5):
    ...
    a = (~np.isnan(region_codes_transition_nan)).argsort(0, kind='mergesort',stable=True) #this gives the indices to sort the array with the nans first along the time axis
