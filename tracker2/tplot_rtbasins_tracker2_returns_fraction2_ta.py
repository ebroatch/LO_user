...
THIS IS THE SAME AS RETURNS_FRACTION BUT WITH DIFFERENT CODES FOR THE REGIONS SO THAT PARTICLES TRANSITING THE SILL IN LESS THAT 1 HOUR CAN BE IDENTIFIED
THIS IS THE TIDALLY AVERAGED VERSION
"""
...
ax.set_xlim(0,80)
ax.set_ylim(0,1)
ax.set_title('Efflux/reflux fractions from TIDALLY AVERAGED particle trajectories')
ax.grid(True)
ax.legend()
...
fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_returns_fraction_ta.png' #UNCOMMENT TO PLOT
plt.savefig(fn_fig)
plt.close()
