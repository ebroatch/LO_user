...
axs[0].set_xlabel('Duration on sill [h]')
axs[1].set_xlabel('Duration on sill [h]')
axs[2].set_xlabel('Duration on sill [h]')
axs[3].set_xlabel('Duration on sill [h]')
axs[4].set_xlabel('Duration on sill [h]')
axs[0].grid(True)
axs[1].grid(True)
axs[2].grid(True)
axs[3].grid(True)
...
axs[3].set_ylim(0,0.14)
axs[4].set_ylim(0,0.14)
axs[4].legend(loc='upper right',bbox_to_anchor=(0.92,1))
...
axs[0].text(.98, .98, 'A', horizontalalignment='right', verticalalignment='top', transform=axs[0].transAxes, fontsize=14, fontweight='bold')
axs[1].text(.98, .98, 'B', horizontalalignment='right', verticalalignment='top', transform=axs[1].transAxes, fontsize=14, fontweight='bold')
axs[2].text(.98, .98, 'C', horizontalalignment='right', verticalalignment='top', transform=axs[2].transAxes, fontsize=14, fontweight='bold')
axs[3].text(.98, .98, 'D', horizontalalignment='right', verticalalignment='top', transform=axs[3].transAxes, fontsize=14, fontweight='bold')
axs[4].text(.98, .98, 'E', horizontalalignment='right', verticalalignment='top', transform=axs[4].transAxes, fontsize=14, fontweight='bold')

# fig.suptitle('Histograms of particle durations on sill')

fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_sill_times_hist2.png' #UNCOMMENT TO PLOT
plt.savefig(fn_fig)
plt.close()
...
ax.grid(True)
ax.legend()
fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_sill_times_avg2.png' #UNCOMMENT TO PLOT
plt.savefig(fn_fig)
plt.close()
