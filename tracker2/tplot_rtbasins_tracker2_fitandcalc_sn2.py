...
for i in range(5):
    ...
    axs[0,1].plot(time_hours/24, A_in_fit2 * np.exp((-time_hours/24)/T_e_in_fit2) * 100, linestyle = ':', color=linecolor2, label=silllenlabel+' fit')
...
axs[0,0].set_ylabel('% of particles remaining')
axs[0,0].set_title('Outer basin')
