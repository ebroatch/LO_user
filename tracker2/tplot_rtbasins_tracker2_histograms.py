...
for i in range(5):
    ...
    rt_strict = np.where(rt_strict==0, tmax, rt_strict) #replace 0 with tmax (every particle is in the estuary at t=0, these are particles that never leave estuary)
