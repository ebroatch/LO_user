...
axs[0].legend(loc='upper left',bbox_to_anchor=(0.04,1))
axs[1].legend(loc='upper left',bbox_to_anchor=(0.16,1))
axs[0].set_aspect(1)
axs[1].set_aspect(1)
axs[0].text(2, 98, 'A', horizontalalignment='left', verticalalignment='top', fontsize=14, fontweight='bold')
axs[1].text(2, 98, 'B', horizontalalignment='left', verticalalignment='top', fontsize=14, fontweight='bold')
...
fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_spatialdist_regions2.png'
plt.savefig(fn_fig)
plt.close()
#plt.show()
