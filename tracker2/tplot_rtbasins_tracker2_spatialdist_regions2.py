...
axs[0].set_aspect(1)
axs[1].set_aspect(1)
axs[0].text(2, 98, 'A', horizontalalignment='left', verticalalignment='top', transform=axs[0].transAxes, fontsize=14, fontweight='bold')
axs[1].text(2, 98, 'B', horizontalalignment='left', verticalalignment='top', transform=axs[0].transAxes, fontsize=14, fontweight='bold')
