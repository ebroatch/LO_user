...
fig2, axs2 = plt.subplots(1,5,figsize=(18,6),layout='constrained')
...
for i in range(5):
    ...
    # hist_inin,binedges_inin = np.histogram(inin_dist_reached,bins=binlist,density=False) #try particle count instead of density
    # hist_outout,binedges_outout = np.histogram(outout_dist_reached,bins=binlist,density=False)
    hist_inin,binedges_inin = np.histogram(inin_dist_reached,bins=binlist,density=True) #density
    hist_outout,binedges_outout = np.histogram(outout_dist_reached,bins=binlist,density=True)
    axs[i].plot(bincenters,hist_outout,lw=2,color='tab:cyan',label='Return to outer basin')
    axs[i].plot(bincenters,hist_inin,lw=2,color='tab:pink',label='Return to inner basin')


    #make an additional plot all the histograms on one plot
    ax3.plot(bincenters,hist_outout,lw=2,color=linecolor,ls='--',label=silllenlabel+' return to outer basin')
    ax3.plot(bincenters,hist_inin,lw=2,color=linecolor,label=silllenlabel+' return to inner basin')


    #SCATTER PLOT OF DISTANCE VS DURATION
    axs2[i].scatter(outout_durations,outout_dist_reached,marker='o',color='tab:cyan',alpha=0.2,label='Return to outer basin')
    axs2[i].scatter(inin_durations,inin_dist_reached,marker='o',color='tab:pink',alpha=0.2,label='Return to inner basin')
...
axs[0].set_ylabel('Fraction of visits')
...
axs[0].text(.02, .02, 'A', horizontalalignment='left', verticalalignment='bottom', transform=axs[0].transAxes, fontsize=14, fontweight='bold')
axs[1].text(.02, .02, 'B', horizontalalignment='left', verticalalignment='bottom', transform=axs[1].transAxes, fontsize=14, fontweight='bold')
axs[2].text(.02, .02, 'C', horizontalalignment='left', verticalalignment='bottom', transform=axs[2].transAxes, fontsize=14, fontweight='bold')
axs[3].text(.02, .02, 'D', horizontalalignment='left', verticalalignment='bottom', transform=axs[3].transAxes, fontsize=14, fontweight='bold')
axs[4].text(.02, .02, 'E', horizontalalignment='left', verticalalignment='bottom', transform=axs[4].transAxes, fontsize=14, fontweight='bold')
...
fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_sill_dist_hist2.png' #UNCOMMENT TO PLOT
fig.savefig(fn_fig)
...
ax3.legend()
fn_fig = Ldir['LOo'] / 'plots' / 'tplot_rtbasins_tracker2_sill_dist_hist_alt2.png' #UNCOMMENT TO PLOT
fig3.savefig(fn_fig)
...
axs2[0].set_xlim(left=0) #might need to adjust these
...
axs2[0].set_box_aspect(1)
axs2[1].set_box_aspect(1)
axs2[2].set_box_aspect(1)
axs2[3].set_box_aspect(1)
axs2[4].set_box_aspect(1)
axs[0].set_box_aspect(1)
axs[1].set_box_aspect(1)
axs[2].set_box_aspect(1)
axs[3].set_box_aspect(1)
axs[4].set_box_aspect(1)
axs2[0].text(.98, .02, 'A', horizontalalignment='left', verticalalignment='bottom', transform=axs2[0].transAxes, fontsize=14, fontweight='bold')
axs2[1].text(.98, .02, 'B', horizontalalignment='left', verticalalignment='bottom', transform=axs2[1].transAxes, fontsize=14, fontweight='bold')
axs2[2].text(.98, .02, 'C', horizontalalignment='left', verticalalignment='bottom', transform=axs2[2].transAxes, fontsize=14, fontweight='bold')
axs2[3].text(.98, .02, 'D', horizontalalignment='left', verticalalignment='bottom', transform=axs2[3].transAxes, fontsize=14, fontweight='bold')
axs2[4].text(.98, .02, 'E', horizontalalignment='left', verticalalignment='bottom', transform=axs2[4].transAxes, fontsize=14, fontweight='bold')
...
ax.plot(silllens_plot,inin_dist_plot,marker='o',c='tab:pink',ls='-',label=r'Distance reached (return to inner basin)')
