...
axs[1].set_yticks([0,0.025,0.05,0.075,0.1,0.125,0.15]) #match gridlines with first plot
axs[2].set_yticks([0,0.025,0.05,0.075,0.1,0.125,0.15])
axs[3].set_yticks([0,0.025,0.05,0.075,0.1,0.125,0.15])
axs[4].set_yticks([0,0.025,0.05,0.075,0.1,0.125,0.15])
...
axs[3].set_box_aspect(1)
axs[4].set_box_aspect(1)
axs2[0].text(.98, .02, 'A', horizontalalignment='right', verticalalignment='bottom', transform=axs2[0].transAxes, fontsize=14, fontweight='bold')
axs2[1].text(.98, .02, 'B', horizontalalignment='right', verticalalignment='bottom', transform=axs2[1].transAxes, fontsize=14, fontweight='bold')
axs2[2].text(.98, .02, 'C', horizontalalignment='right', verticalalignment='bottom', transform=axs2[2].transAxes, fontsize=14, fontweight='bold')
