...
lon2 = dsr.lon.where((dsr.lon.sel(Time=0)<sillland) & (dsr.lon.sel(Time=0)>sillsea),drop=True,drop=True).values
lat1 = dsr.lat.where((dsr.lon.sel(Time=12)<sillland) & (dsr.lon.sel(Time=12)>sillsea),drop=True,drop=True).values
lat2 = dsr.lat.where((dsr.lon.sel(Time=12)<sillland) & (dsr.lon.sel(Time=12)>sillsea),drop=True,drop=True).values
