...
step = 1 #step for subsampling lines
ax.plot(lon[:,::step], z[:,::step], '-k', linewidth=.2)
ax.plot(lon[0,:], z[0,:], 'og', alpha=.3)
ax.plot(lon[-1,:], z[-1,:], 'or', alpha=.3)
ax2.plot(lon2[:,::step], z2[:,::step], '-k', linewidth=.2)
ax2.plot(lon2[0,:], z2[0,:], 'og', alpha=.3)
