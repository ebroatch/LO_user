...
def P_spdmap_eb(in_dict):
    ...
    ax1.quiver(ds.lon_rho[::10,::10].values, ds.lat_rho[::10,::10].values, u_rho[::10,::10], v_rho[::10,::10], color='k', scale=10, scale_units='x')
    ax1.set_title('Plume focus', fontsize=12)
    #fig.colorbar(cs1)
    ax1.axis(aa1)
    pfun.dar(ax1)
    ...
    ax2.quiver(ds.lon_rho[::20,::20].values, ds.lat_rho[::20,::20].values, u_rho[::20,::20], v_rho[::20,::20], color='k', scale=10, scale_units='x')
    ax2.set_title('Full model', fontsize=12)
    #fig.colorbar(cs2)
    ax2.axis(aa2)
    pfun.dar(ax2)
    ...
    ax3.quiver(ds.lon_rho[::4,::4].values, ds.lat_rho[::4,::4].values, u_rho[::4,::4], v_rho[::4,::4], color='k', scale=10, scale_units='x')
    ax3.set_title('Estuary focus', fontsize=12)
    ax3.axis(aa3)
    pfun.dar(ax3)
    ax3.set_xlabel('Longitude')
