...
def P_spdmap_eb(in_dict):
    ...
    # create fields
    u_rho = ds.zeta * np.nan
    v_rho = ds.zeta * np.nan
    ...
    ax1.quiver(ds.lon_rho.values, ds.lat_rho.values, u_rho, v_rho, color='k', scale=10, scale_units='width')
    ax1.set_title('Plume focus', fontsize=12)
    #fig.colorbar(cs1)
    ax1.axis(aa1)
    pfun.dar(ax1)
    ...
    ax2.quiver(ds.lon_rho.values, ds.lat_rho.values, u_rho, v_rho, color='k', scale=10, scale_units='width')
    ax2.set_title('Full model', fontsize=12)
    #fig.colorbar(cs2)
    ax2.axis(aa2)
    pfun.dar(ax2)
    ...
    ax3.quiver(ds.lon_rho.values, ds.lat_rho.values, u_rho, v_rho, color='k', scale=10, scale_units='width')
    ax3.set_title('Estuary focus', fontsize=12)
    ax3.axis(aa3)
    pfun.dar(ax3)
    ax3.set_xlabel('Longitude')
