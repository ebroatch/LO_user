...
def P_sect_contour_u_eb(in_dict):
    ...
    cs = ax.contour(dist_plot,z_plot,sf_u,
                        levels=[-0.2,-0.18,-0.16,-0.14,-0.12,-0.1,-0.08,-0.06,-0.04,-0.02,0,0.02,0.04,0.06,0.08,0.1,0.12,0.14,0.16,0.18,0.2], colors='k',linewidths=0.5, negative_linestyles='solid') #contour with manual vmax/vmin
